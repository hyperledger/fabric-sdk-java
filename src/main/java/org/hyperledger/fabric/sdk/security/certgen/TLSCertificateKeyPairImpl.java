 ...
 */
public class TLSCertificateKeyPairImpl implements TLSCertificateKeyPair  {
    private byte[] certPemBytes;
    private byte[] certDerBytes;
    private byte[] keyPemBytes;

    private TLSCertificateKeyPairImpl(byte[] certPemBytes, byte[] certDerBytes, byte[] keyPemBytes) {
    ...
    static TLSCertificateKeyPair fromX509CertKeyPair(X509Certificate x509Cert, KeyPair keyPair) throws IOException {
        ...
        return new TLSCertificateKeyPairImpl(pemBytes, derBytes, keyBytes);
    }
